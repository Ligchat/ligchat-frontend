...
export const getMessageSchedulings = async (): Promise<MessageScheduling[]> => {
  ...
  try {
    const response = await axios.get(`/api/message-schedulings?sectorId=${sectorId}`, {
      headers: {
...
export const getMessageScheduling = async (id: number): Promise<MessageScheduling> => {
  try {
    const response = await axios.get(`/api/message-schedulings/${id}`, {
      headers: {
        'Accept': 'application/json',
      },
    });
...
export const createMessageScheduling = async (
  ...
  try {
    const response = await axios.post('/api/message-schedulings', messageData, {
      headers: {
...
export const updateMessageScheduling = async (
  ...
  try {
    const response = await axios.put(`/api/message-schedulings/${id}`, data, {
      headers: {
        'Content-Type': 'application/json',
      },
    });
...
export const deleteMessageScheduling = async (id: number): Promise<void> => {
  try {
    await axios.delete(`/api/message-schedulings/${id}`);
  } catch (error: any) {
